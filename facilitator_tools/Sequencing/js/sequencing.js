...
SequencingApp.buildActivity = function() {
    ...
    $(window).resize(function() {
        for (var listItem = 0; listItem < $('.sortItem').length; listItem++) {
            ...
            $('#sortList').width($('#placeholderContent').width());
             $('#sortList').width($('#placeholderContent').width()+10);
        }
    });
...
SequencingApp.buildReport = function() {
    ...
    for (var n in SequencingApp.userResult) {
        ...
        stepYourAnswer.innerHTML = '<p><strong>Your choice:</strong></p>';
        if (SequencingApp.userResult[n].result !== 'Correct') {
        ...
        if (SequencingApp.userResult[n].result !== 'Correct') {
            ...
            if (SequencingApp.AppData.sortItemsType === 'image') {
                ...
                stepYourAnswer.innerHTML += '<div class="result" id="result' + n + '"><div>' + SequencingApp.userResult[n].userStepAnswer.text + '</div></div>';
            }
        ...
        stepYourAnswer.innerHTML += '<div id=\'userResult\'>' + imageSrc + ' <strong style=\'vertical-align: super;\'>' + SequencingApp.userResult[n].result + '.</strong></div>';
        // sectionContainer.appendChild(stepYourAnswer);
        ...
        if (SequencingApp.userResult[n].result !== 'Correct') {
            ...
            if (SequencingApp.AppData.sortItemsType === 'image') {
                ...
                stepCorrectAnswer.innerHTML = '<p><strong>Correct choice:</strong></p><div class="result" id="correctResult' + n + '"><div>' + SequencingApp.userResult[n].correctStepAnswer.text + '</div></div>';
            }
        }
        // else {
        //     var stepCorrectAnswer = document.createElement('p');
